...
# ================================================================
# 候选服务器（来源: 通达信 connect.cfg [DSHOST] 段）
# ================================================================

TDX_EX_CANDIDATE_SERVERS = [
    # ---- ExHQ 7727 官方 [DSHOST] ----
    ("112.74.214.43", 7727),   # 深圳双线1
    ("120.25.218.6", 7727),    # 深圳双线2
    ("47.107.75.159", 7727),   # 深圳双线3
    ("119.97.185.5", 7727),    # 武汉站1
    ("59.175.238.38", 7727),   # 武汉站2
    ("106.14.95.149", 7727),   # 上海双线1
    ("47.102.108.214", 7727),  # 上海双线2
    # ---- ExHQ 7727 历史可用 ----
    ("180.153.18.170", 7727), ("180.153.18.171", 7727),
