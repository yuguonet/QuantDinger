...
def _detect_market(stock_code: str) -> str:
    """Detect market type, falling back to CNStock if unknown.

    Delegates to data_sources.market_detector for comprehensive detection.
    """
    from app.data_sources.market_detector import detect_market
    return detect_market(stock_code) or "CNStock"
