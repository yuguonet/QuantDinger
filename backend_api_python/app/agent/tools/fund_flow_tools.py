...
def get_fund_flow(stock_codes: str = "", output: str = "markdown") -> str:
...
def get_sector_fund_flow(indicator: str = "今日", output: str = "markdown") -> str:
    ...
    try:
        ...
        return {"error": str(e)}
def get_concept_fund_flow(indicator: str = "今日", output: str = "markdown") -> str:
    ...
    try:
        ...
        return {"error": str(e)}
def get_fund_flow_daily(codes: str, days: int = 120, output: str = "markdown") -> str:
    ...
    from app.agent.utils.md_format import _to_md
    return json.dumps(_r, ensure_ascii=False) if output == "json" else _to_md(_r)
def get_market_fund_flow( output: str = "markdown") -> str:
    ...
    try:
        ...
        return {"error": str(e)}
def get_northbound_flow( output: str = "markdown") -> str:
