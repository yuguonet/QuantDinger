# -*- coding: utf-8 -*-
"""
Screening tools — indicator-based stock review.

Wraps indicator review logic into Agent-callable tools.
Note: For market-wide screening (EastMoney API), see stock_screener_tools.py.
"""
