...
def build_default_routes() -> List[Route]:
    ...
    return [
        ...
        Route(
            ...
            metadata={"domain": "finance", "intent": "stock_analysis",
        ...
        Route(
            ...
            metadata={"domain": "finance", "intent": "chart_view",
        ...
        Route(
            ...
            metadata={"domain": "finance", "intent": "market_scan",
        ...
        Route(
            ...
            metadata={"domain": "finance", "intent": "screener",
        ...
        Route(
            ...
            metadata={"domain": "finance", "intent": "backtest",
        ...
        Route(
            ...
            metadata={"domain": "finance", "intent": "fund_flow",
        ...
        Route(
            ...
            metadata={"domain": "finance", "intent": "indicator",
        ...
        Route(
            ...
            metadata={"domain": "finance", "intent": "trading",
        ...
        Route(
            ...
            metadata={"domain": "finance", "intent": "stock_info",
                      "tool_categories": ["名称查询", "行情数据"]},
        ),
        Route(
            ...
            metadata={"domain": "finance", "intent": "concept_explain"},
        ),
        ...
        Route(
            ...
            metadata={"domain": "coding", "intent": "code_modify",
                      "tool_categories": ["工作区"]},
        ),
        Route(
            ...
            metadata={"domain": "coding", "intent": "code_create",
                      "tool_categories": ["工作区"]},
        ),
        Route(
            ...
            metadata={"domain": "coding", "intent": "project_scan",
                      "tool_categories": ["工作区"]},
        ),
