...
工具直接调用，格式: `tool_name(param="value")`。
...
codes = filter_candidates(prescreen_result=result)
...
301379	天山电子	55.0	中性	0.25	MACD金叉, 放量1.8倍
300129	泰胜风能	22.0	看空	0.75	突破前低, MA空头排列, 放量1.8倍
```
