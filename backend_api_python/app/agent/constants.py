...
# ── 常设：agent 侧 env 声明清单（与 os.getenv 对账用，standing_checks）──
AGENT_ENV_KEYS = (
    "AGENT_CODE_REPAIR", "AGENT_ENV", "AGENT_EVAL_DUMP", "AGENT_JSONL_ENABLED",
    "AGENT_LLM_MODEL", "AGENT_LLM_SEED", "AGENT_LLM_TEMPERATURE", "AGENT_MAX_STEPS",
    "AGENT_MEMORY_MAX_HISTORY", "AGENT_PANEL_FILE", "AGENT_PLAN_BEST_OF_N",
    "AGENT_PLAN_CRITIC", "AGENT_ROUTING_DOWNGRADE", "AGENT_RUN_WALL_TIMEOUT",
    "AGENT_RUN_TOKEN_BUDGET", "AGENT_RUN_TOOL_CALL_BUDGET", "AGENT_DAY_TOKEN_QUOTA",
    "AGENT_TRACE_FILE", "AGENT_TRACE_MAX_CHARS", "AGENT_TYPE", "AGENT_UPGRADE_TOOL_CALLS",
    "CAPABILITIES_ENABLED", "CASE_MEMORY_ENABLED", "CASE_SIM_MIN", "CASE_DUP_SIM",
    "CLI_RUN_TIMEOUT", "LOG_LEVEL", "MEMORY_BACKEND",
)
