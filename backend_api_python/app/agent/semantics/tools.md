...
categories:
  ...
  - name: shell_exec
    ...
    domain:
    - coding
  - name: workspace_save_script
    description: 保存 Python 脚本到工作区，支持自动版本管理。
    category: 工作区
    layer: 支撑层
    domain:
    - coding
  - name: workspace_load_script
  ...
  - name: get_sector_stocks
    ...
    domain:
    - finance
  - name: get_hot_stocks_with_reason
