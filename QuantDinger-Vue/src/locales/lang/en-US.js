...
const locale = {
  ...
  'dashboard.analysis.watchlist.group.join': 'Join Group',
  'dashboard.analysis.watchlist.group.newNamePlaceholder': 'Pick a group, or type a new name to create it now (takes priority)',
  'dashboard.analysis.watchlist.group.rename': 'Rename Group',
  'dashboard.analysis.watchlist.group.renameModalTitle': 'Rename Group',
  'dashboard.analysis.watchlist.group.delete': 'Delete Group',
  'dashboard.analysis.watchlist.group.deleteConfirm': 'Delete this group and its {count} watchlist item(s)?',
  'dashboard.analysis.watchlist.group.default': 'Default',
  'dashboard.analysis.watchlist.group.nameRequired': 'Please enter a group name',
  'dashboard.analysis.watchlist.group.nameTooLong': 'Group name must not exceed 50 characters',
  'dashboard.analysis.watchlist.group.nameExists': 'Group name already exists',
  'dashboard.analysis.watchlist.group.cannotModifyDefault': 'The default group cannot be renamed or deleted',
  'dashboard.analysis.watchlist.group.renamed': 'Group renamed',
  'dashboard.analysis.watchlist.group.deleted': 'Group deleted',
  'dashboard.analysis.watchlist.group.renameFailed': 'Failed to rename group',
  'dashboard.analysis.watchlist.group.deleteFailed': 'Failed to delete group',
  'dashboard.analysis.watchlist.group.notFound': 'Group does not exist',
  ...
  'dashboard.analysis.modal.addStock.searchOrInputPlaceholder': 'Enter symbol code, comma-separated for batch add (e.g.: AAPL, AAPL,MSFT)',
  'dashboard.analysis.modal.addStock.searchPlaceholderCN': 'Enter code/name/pinyin, comma-separated for batch add (e.g.: 600519, 600519,000858)',
  ...
  'indicatorIde.chartTab': 'K-Line Chart',
