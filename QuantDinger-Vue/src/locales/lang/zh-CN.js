...
const locale = {
  ...
  'menu.dashboard.aiAssetAnalysis': 'AI价值分析',
  ...
  'dashboard.analysis.watchlist.group.join': '加入分组',
  'dashboard.analysis.watchlist.group.newNamePlaceholder': '选择已有分组，或输入名称即时创建新组（优先）',
  'dashboard.analysis.watchlist.group.rename': '重命名分组',
  'dashboard.analysis.watchlist.group.renameModalTitle': '重命名分组',
  'dashboard.analysis.watchlist.group.delete': '删除分组',
  'dashboard.analysis.watchlist.group.deleteConfirm': '将删除该组 {count} 只自选股，确定删除？',
  'dashboard.analysis.watchlist.group.default': '默认自选',
  'dashboard.analysis.watchlist.group.nameRequired': '请输入分组名称',
  'dashboard.analysis.watchlist.group.nameTooLong': '分组名称不能超过50个字符',
  'dashboard.analysis.watchlist.group.nameExists': '该分组名称已存在',
  'dashboard.analysis.watchlist.group.cannotModifyDefault': '默认自选分组不可重命名或删除',
  'dashboard.analysis.watchlist.group.renamed': '分组已重命名',
  'dashboard.analysis.watchlist.group.deleted': '分组已删除',
  'dashboard.analysis.watchlist.group.renameFailed': '重命名分组失败',
  'dashboard.analysis.watchlist.group.deleteFailed': '删除分组失败',
  'dashboard.analysis.watchlist.group.notFound': '分组不存在',
  ...
  'dashboard.analysis.modal.addStock.searchPlaceholderCN': '输入代码、名称或拼音首字母，逗号分隔可批量添加（如：600519、600519,000858）',
