      ...
      <div class="result-table">
        ...
        <div class="table-scroll-wrapper">
          ...
          >
            ...
            <el-table-column prop="macd_golden_forkz" label="MACD金叉Z" width="100">
              <template slot-scope="scope">{{ scope.row.macd_golden_forkz ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="macd_golden_forky" label="MACD金叉Y" width="100">
              <template slot-scope="scope">{{ scope.row.macd_golden_forky ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="kdj_golden_forkz" label="KDJ金叉Z" width="100">
              <template slot-scope="scope">{{ scope.row.kdj_golden_forkz ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="kdj_golden_forky" label="KDJ金叉Y" width="100">
              <template slot-scope="scope">{{ scope.row.kdj_golden_forky ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="restore_justice" label="复权" width="70">
              <template slot-scope="scope">{{ scope.row.restore_justice ? '✓' : '' }}</template>
            </el-table-column>
            <!-- ========== ⑩ K线形态与连涨连跌 ========== -->
            <el-table-column prop="power_fulgun" label="乌云盖顶" width="90">
              <template slot-scope="scope">{{ scope.row.power_fulgun ? '⚠' : '' }}</template>
            </el-table-column>
            <el-table-column prop="pregnant" label="孕线" width="70">
              <template slot-scope="scope">{{ scope.row.pregnant ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="black_cloud_tops" label="黑云压顶" width="90">
              <template slot-scope="scope">{{ scope.row.black_cloud_tops ? '⚠' : '' }}</template>
            </el-table-column>
            <el-table-column prop="narrow_finish" label="窄幅整理" width="90">
              <template slot-scope="scope">{{ scope.row.narrow_finish ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="reversing_hammer" label="反转锤子" width="90">
              <template slot-scope="scope">{{ scope.row.reversing_hammer ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="first_dawn" label="第一天黎明" width="100">
              <template slot-scope="scope">{{ scope.row.first_dawn ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="bearish_engulfing" label="看跌吞没" width="90">
              <template slot-scope="scope">{{ scope.row.bearish_engulfing ? '⚠' : '' }}</template>
            </el-table-column>
            <el-table-column prop="upside_volume" label="上攻放量" width="90">
              <template slot-scope="scope">{{ scope.row.upside_volume ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="heaven_rule" label="天道法则" width="90">
              <template slot-scope="scope">{{ scope.row.heaven_rule ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="down_7days" label="连续7天下跌" width="110">
              <template slot-scope="scope">{{ scope.row.down_7days ? '⚠' : '' }}</template>
            </el-table-column>
            <el-table-column prop="upper_8days" label="连续8天上涨" width="110">
              <template slot-scope="scope">{{ scope.row.upper_8days ? '🔥' : '' }}</template>
            </el-table-column>
            <el-table-column prop="upper_9days" label="连续9天上涨" width="110">
              <template slot-scope="scope">{{ scope.row.upper_9days ? '🔥' : '' }}</template>
            </el-table-column>
            <el-table-column prop="upper_4days" label="连续4天上涨" width="110">
              <template slot-scope="scope">{{ scope.row.upper_4days ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="upp_days" label="连续上涨天数" width="110"></el-table-column>
            <el-table-column prop="down_days" label="连续下跌天数" width="110"></el-table-column>
            <el-table-column prop="upnday" label="连续上涨天数" width="110"></el-table-column>
            <el-table-column prop="downnday" label="连续下跌天数" width="110"></el-table-column>
            <!-- ========== ⑪ 板块标识与新高新低 ========== -->
            <el-table-column prop="is_sz50" label="上证50" width="80">
              <template slot-scope="scope">{{ scope.row.is_sz50 === 'Y' ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="is_zz1000" label="中证1000" width="90">
              <template slot-scope="scope">{{ scope.row.is_zz1000 === 'Y' ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="is_cy50" label="创业板50" width="90">
              <template slot-scope="scope">{{ scope.row.is_cy50 === 'Y' ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="is_issue_break" label="是否破板" width="90">
              <template slot-scope="scope">{{ scope.row.is_issue_break ? '是' : '' }}</template>
            </el-table-column>
            <el-table-column prop="is_bps_break" label="是否破净" width="90">
              <template slot-scope="scope">{{ scope.row.is_bps_break ? '是' : '' }}</template>
            </el-table-column>
            <el-table-column prop="now_newhigh" label="当前新高" width="90">
              <template slot-scope="scope">{{ scope.row.now_newhigh ? '🔥' : '' }}</template>
            </el-table-column>
            <el-table-column prop="now_newlow" label="当前新低" width="90">
              <template slot-scope="scope">{{ scope.row.now_newlow ? '⚠' : '' }}</template>
            </el-table-column>
            <el-table-column prop="high_recent_3days" label="3天新高" width="80">
              <template slot-scope="scope">{{ scope.row.high_recent_3days ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="high_recent_5days" label="5天新高" width="80">
              <template slot-scope="scope">{{ scope.row.high_recent_5days ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="high_recent_10days" label="10天新高" width="90">
              <template slot-scope="scope">{{ scope.row.high_recent_10days ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="high_recent_20days" label="20天新高" width="90">
              <template slot-scope="scope">{{ scope.row.high_recent_20days ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="high_recent_30days" label="30天新高" width="90">
              <template slot-scope="scope">{{ scope.row.high_recent_30days ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="low_recent_3days" label="3天新低" width="80">
              <template slot-scope="scope">{{ scope.row.low_recent_3days ? '⚠' : '' }}</template>
            </el-table-column>
            <el-table-column prop="low_recent_5days" label="5天新低" width="80">
              <template slot-scope="scope">{{ scope.row.low_recent_5days ? '⚠' : '' }}</template>
            </el-table-column>
            <el-table-column prop="low_recent_10days" label="10天新低" width="90">
              <template slot-scope="scope">{{ scope.row.low_recent_10days ? '⚠' : '' }}</template>
            </el-table-column>
            <el-table-column prop="low_recent_20days" label="20天新低" width="90">
              <template slot-scope="scope">{{ scope.row.low_recent_20days ? '⚠' : '' }}</template>
            </el-table-column>
            <el-table-column prop="low_recent_30days" label="30天新低" width="90">
              <template slot-scope="scope">{{ scope.row.low_recent_30days ? '⚠' : '' }}</template>
            </el-table-column>
            <el-table-column prop="win_market_3days" label="3天战胜大盘" width="110">
              <template slot-scope="scope">{{ scope.row.win_market_3days ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="win_market_5days" label="5天战胜大盘" width="110">
              <template slot-scope="scope">{{ scope.row.win_market_5days ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="win_market_10days" label="10天战胜大盘" width="110">
              <template slot-scope="scope">{{ scope.row.win_market_10days ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="win_market_20days" label="20天战胜大盘" width="110">
              <template slot-scope="scope">{{ scope.row.win_market_20days ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="win_market_30days" label="30天战胜大盘" width="110">
              <template slot-scope="scope">{{ scope.row.win_market_30days ? '✓' : '' }}</template>
            </el-table-column>
            <!-- ========== ⑫ 资金流向与涨跌幅 ========== -->
            <el-table-column prop="net_inflow" label="净流入金额" sortable width="110"></el-table-column>
            <el-table-column prop="netinflow_3days" label="3天净流入" sortable width="110"></el-table-column>
            <el-table-column prop="netinflow_5days" label="5天净流入" sortable width="110"></el-table-column>
            <el-table-column prop="nowinterst_ratio" label="当前利息比率" width="110"></el-table-column>
            <el-table-column prop="nowinterst_ratio_3d" label="利息比率3天" width="110"></el-table-column>
            <el-table-column prop="nowinterst_ratio_5d" label="利息比率5天" width="110"></el-table-column>
            <el-table-column prop="ddx" label="大单动向" width="90"></el-table-column>
            <el-table-column prop="ddx_3d" label="大单动向3天" width="110"></el-table-column>
            <el-table-column prop="ddx_5d" label="大单动向5天" width="110"></el-table-column>
            <el-table-column prop="ddx_red_10d" label="大单红10天" width="100"></el-table-column>
            <el-table-column prop="changerate_3days" label="3天涨跌幅(%)" width="110">
              <template slot-scope="scope">
                <span :class="scope.row.changerate_3days >= 0 ? 'text-red' : 'text-green'">
                  {{ scope.row.changerate_3days && scope.row.changerate_3days.toFixed(2) }}
                </span>
              </template>
            </el-table-column>
            <el-table-column prop="changerate_5days" label="5天涨跌幅(%)" width="110">
              <template slot-scope="scope">
                <span :class="scope.row.changerate_5days >= 0 ? 'text-red' : 'text-green'">
                  {{ scope.row.changerate_5days && scope.row.changerate_5days.toFixed(2) }}
                </span>
              </template>
            </el-table-column>
            <el-table-column prop="changerate_10days" label="10天涨跌幅(%)" width="120">
              <template slot-scope="scope">
                <span :class="scope.row.changerate_10days >= 0 ? 'text-red' : 'text-green'">
                  {{ scope.row.changerate_10days && scope.row.changerate_10days.toFixed(2) }}
                </span>
              </template>
            </el-table-column>
            <el-table-column prop="changerate_ty" label="年度涨跌幅(%)" width="110">
              <template slot-scope="scope">
                <span :class="scope.row.changerate_ty >= 0 ? 'text-red' : 'text-green'">
                  {{ scope.row.changerate_ty && scope.row.changerate_ty.toFixed(2) }}
                </span>
              </template>
            </el-table-column>
            <el-table-column prop="listing_yield_year" label="上市年化收益率(%)" width="130"></el-table-column>
            <el-table-column prop="listing_volatility_year" label="上市年化波动率(%)" width="130"></el-table-column>
            <!-- ========== ⑬ 互联互通 ========== -->
            <el-table-column prop="mutual_netbuy_amt" label="互联互通净买入" sortable width="120"></el-table-column>
            <el-table-column prop="hold_ratio" label="持股比例(%)" width="100"></el-table-column>
            <!-- ========== ⑭ 人气排名 ========== -->
            <el-table-column prop="popularity_rank" label="人气排名" sortable width="90"></el-table-column>
            <el-table-column prop="rank_change" label="排名变化" sortable width="90"></el-table-column>
            <el-table-column prop="new_high" label="新高次数" width="90"></el-table-column>
            <el-table-column prop="new_down" label="新低次数" width="90"></el-table-column>
            <el-table-column prop="newfans_ratio" label="新粉丝比率(%)" width="110"></el-table-column>
            <el-table-column prop="bigfans_ratio" label="大粉丝比率(%)" width="110"></el-table-column>
            <el-table-column prop="concern_rank_7days" label="关注排名7天" width="110"></el-table-column>
            <el-table-column prop="browse_rank" label="浏览排名" width="90"></el-table-column>
            <!-- ========== ⑮ 其它 ========== -->
            <el-table-column prop="par_dividend_pretax" label="税前派息率(%)" width="110"></el-table-column>
            <el-table-column prop="par_dividend" label="派息率(%)" width="90"></el-table-column>
            <el-table-column prop="par_it_equity" label="派息率权益(%)" width="110"></el-table-column>
            <el-table-column prop="predict_type" label="预测类型" width="90"></el-table-column>
            <el-table-column prop="pledge_ratio" label="质押比例(%)" width="100"></el-table-column>
            <el-table-column prop="goodwill_scale" label="商誉规模" width="100"></el-table-column>
            <el-table-column prop="goodwill_assets_ratro" label="商誉资产比率(%)" width="120"></el-table-column>
            <el-table-column prop="limited_lift_f6m" label="限价上涨6月(F)" width="120">
              <template slot-scope="scope">{{ scope.row.limited_lift_f6m ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="limited_lift_f1y" label="限价上涨1年(F)" width="120">
              <template slot-scope="scope">{{ scope.row.limited_lift_f1y ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="limited_lift_6m" label="限价上涨6月" width="110">
              <template slot-scope="scope">{{ scope.row.limited_lift_6m ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="limited_lift_1y" label="限价上涨1年" width="110">
              <template slot-scope="scope">{{ scope.row.limited_lift_1y ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="directional_seo_1m" label="定向增发1月" width="110">
              <template slot-scope="scope">{{ scope.row.directional_seo_1m ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="directional_seo_3m" label="定向增发3月" width="110">
              <template slot-scope="scope">{{ scope.row.directional_seo_3m ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="directional_seo_6m" label="定向增发6月" width="110">
              <template slot-scope="scope">{{ scope.row.directional_seo_6m ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="directional_seo_1y" label="定向增发1年" width="110">
              <template slot-scope="scope">{{ scope.row.directional_seo_1y ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="recapitalize_1m" label="定增1月(R)" width="100">
              <template slot-scope="scope">{{ scope.row.recapitalize_1m ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="recapitalize_3m" label="定增3月(R)" width="100">
              <template slot-scope="scope">{{ scope.row.recapitalize_3m ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="recapitalize_6m" label="定增6月(R)" width="100">
              <template slot-scope="scope">{{ scope.row.recapitalize_6m ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="recapitalize_1y" label="定增1年(R)" width="100">
              <template slot-scope="scope">{{ scope.row.recapitalize_1y ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="equity_pledge_1m" label="股权质押1月" width="100">
              <template slot-scope="scope">{{ scope.row.equity_pledge_1m ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="equity_pledge_3m" label="股权质押3月" width="100">
              <template slot-scope="scope">{{ scope.row.equity_pledge_3m ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="equity_pledge_6m" label="股权质押6月" width="100">
              <template slot-scope="scope">{{ scope.row.equity_pledge_6m ? '✓' : '' }}</template>
            </el-table-column>
            <el-table-column prop="equity_pledge_1y" label="股权质押1年" width="100">
              <template slot-scope="scope">{{ scope.row.equity_pledge_1y ? '✓' : '' }}</template>
            </el-table-column>
