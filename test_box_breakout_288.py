...
═══════════════════════════════════════════════════════════════════
  ...
  ① 三均线共振: MA10/MA20/MA60 斜率全部递增
  ② 回调买入: 价格回调到MA20附近(±pct%)
  ③ 反弹确认: 收阳线/量缩/长下影线(至少满足一个)
  ④ 买入: 确认后次日开盘买
...
═══════════════════════════════════════════════════════════════════
  ...
  python test_box_breakout.py --pullback-ma 20 --pullback-pct 3
  python test_box_breakout.py --min-ma10-slope 0.5 --min-ma60-slope 0.1
"""
...
if __name__ == "__main__":
    ...
    print(f"  ② 箱体参数: {args.box_days}日窗口, 振幅{args.box_min_range}%~{args.box_max_range}%")
